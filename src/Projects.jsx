  ...
  return (
    ...
    <div>
      ...
      <section>
        ...
        <div>
          <img src="/web/images/art1.png" alt="Art 1" className="gallery-image" />
          <img src="/web/images/art2.png" alt="Art 2" className="gallery-image" />
          <img src="/web/images/art3.png" alt="Art 3" className="gallery-image" /> 
        </div>
      </section>
    </div>
