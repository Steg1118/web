    ...
    <>
      <div>
        ...
        <a href="https://github.com/Steg1118" target="_blank">
          <img src="/web/images/snichead.png" className="logo" alt="sonic logo" />
        </a>
      </div>
      ...
      <a href="https://github.com/Steg1118" target="_blank">
          <img src="/web/images/GitHub-Simbolo-1555934127.png" className="logolink" alt="githublogo" style={{ width: "100px", height: "50px" }} />
      </a>
      <a href="https://github.com/Steg1118" target="_blank">
          <img src="/web/images/Linkedin-Logo-3802517563.png" className="logolink" alt="LinkedInlogo" style={{ width: "100px", height: "50px" }} />
      </a>
    </>
  )
}
